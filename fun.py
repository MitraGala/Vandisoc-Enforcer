...
cahquestions = ["Holy shit I hate EMU.","What is the most esoteric thing ever? EMU.","What did EMU do between 1933-1945?","Mirror, mirror on the wall, who is the gayest of them all? EMU.","Holy fucking shit I could fuck EMU right now.","EMU? There's an app for that", "Why can't I sleep at night? EMU", "What's that smell? EMU", "I got 99 problems but EMU ain't one.", "Who stole the cookies from the cookie jar? EMU", "What's the next Happy Meal (r) toy? EMU", "Anthropologists have recently discovered a primitive tribe that worships EMU.", "It's a pity that kids these days are all getting involved with EMU.", "During Picasso's often-overlooked Brown Period, he produced hundreds of paintings of EMU.", "Alternative medicine is now embracing the curative powers of EMU.", "What's that sound? EMU", "What ended my last relationship? EMU", "MTV's new reality TV show features eight washed-up celebrities living with EMU.", "I drink to forget EMU.", "I'm sorry, I couldn't complete my homework because of EMU.", "What is Batman's guilty pleasure? EMU", "This is the way the world ends. Not with a bang but with EMU.", "What's a girl's best friend? EMU", "TSA guidelines now prohibit EMU on airplanes.", "EMU. That's how I want to die.", "In the new Disney Channel Original Movie, Hannah Montana struggles with EMU for the first time.", "What does Dick Cheney prefer? EMU", "I wish I hadn't lost the instruction manual for EMU.", "Instead of coal, Santa now gives the bad children EMU.", "What's the most emo? EMU", "In 1,000 years, when paper money is but a distant memory, EMU will be our currency.", "A romantic, candlelit dinner would be incomplete without EMU.", "EMU. Betcha can't have just one!", "White people like EMU.", "EMU. High five, bro.", "Next from J.K. Rowling: Harry Potter and Chamber of EMU.", "BILLY MAYS HERE FOR EMU.", "War! What is it good for? EMU", "During sex, I like to think about EMU.", "What are my parents hiding from me? EMU", "What will always get you laid? EMU", "When I'm in prison, I'll have EMU smuggled in.", "What did I bring back from Mexico? EMU", "What don't you want to find in your Chinese food? EMU", "What will I bring back in time to convince people that I am a powerful wizard? EMU", "How am I maintaining my relationship status? EMU", "Coming to Broadway this season, EMU: The Musical.", "While the United States raced the Soviet Union to the moon, the Mexican government funnelled millions of pesos into research on EMU.", "After Hurricane Katrina, Sean Penn brought EMU to the people of New Orleans.", "Due to a PR fiasco, Walmart no longer offers EMU.", "But before I kill you Mr. Bond, I must show you EMU.", "What gives me uncontrollable gas? EMU", "What do old people smell like? EMU", "The class field trip was completely ruined by EMU.", "When Pharaoh remained unmoved, Moses called down a Plague of EMU.", "What's my secret power? EMU", "what's there a ton of in heaven? EMU", "What would grandma find disturbing, yet oddly charming? EMU", "The US has begun airdropping EMU to the children of Afghanistan.", "What helps Obama unwind? EMU", "What did Vin Diesel eat for dinner? EMU", "EMU: good to the last drop.", "Why am I sticky? EMU", "What gets better with age? EMU", "EMU: kid-tested, mother-approved.", "What's the crustiest? EMU", "What's Teach for America using to inspire inner city students to succeed? EMU", "Studies show that lab rats navigate mazes 50% faster after being exposed to EMU.", "Life was difficult for cavemen before EMU.", "I do not know with what weapons World War III will be fought, but World War IV will be fought with EMU.", "Why do I hurt all over? EMU", "What am I giving up for Lent? EMU", "In Michael Jackson's final moments, he thought about EMU.", "In an attempt to reach a wider audience, the Smithsonian Museum of Natural History has opened an interactive exhibit on EMU.", "When I am President of the United States, I will create the department of EMU.", "When I am a billionare, I shall erect a 50-foot statue to commemorate EMU.", "What's my anti-drug? EMU", "What never fails to liven up the party? EMU", "What's the new fad diet? EMU", "Major League Baseball has banned EMU for giving players an unfair advantage."]
